<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="Fruit.Pages.register" %>
	...
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
	            ...
	            <div class="form-group">
                    <asp:Button ID="Button1" runat="server" Text="Sign In" OnClick="RegesterClient" class="form-control btn btn-primary submit px-3" />
	            </div>
