<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Pages/Site1.Master" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="Fruit.Admin.Pages.Product.add" %>
                  ...
                  <div class="col-md-6">
                    <form runat="server">
                      ...
                      <label class="input-group-text" for="inputGroupFile01">Image Upload</label>
                        ...
                        <asp:Button ID="Button1" runat="server" Text="Add" class="btn btn-primary mb-4" OnClick="AddProduct" />
                    </form>
                  </div>
                </div>
              </div>
